import svgPaths from "./svg-lmq9xmd8ye";

function Text() {
  return (
    <div className="content-stretch flex items-start max-w-[368px] min-w-[141px] relative shrink-0" data-name="Text">
      <p className="flex-[1_0_0] font-['SF_Pro_Text:Regular',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[#0e0e0e] text-[14px] whitespace-pre-wrap">При достижении оборота 500 тыс ₽ по всем терминалам в месяц, комиссия составит 2,2% до конца месяца — на все платежи сверх лимита</p>
    </div>
  );
}
